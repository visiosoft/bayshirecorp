...
export const metadata: Metadata = {
  title: "Technology & Automation | Bayshire",
  description:
    "Design and build CRM, custom software, integrations, AI workflows, and automations around a clear process. Technology that serves your operations.",
};
  ...
  return (
    <>
      <HeroSection
        ...
        description="Design and build CRM, custom software, integrations, AI workflows, and automations around a clear process."
      />
      ...
      <section className="bg-white py-24 lg:py-32">
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <ul className="space-y-4">
            {[
              "Tools added without process design",
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              "Design system architecture around business processes",
              "Implement CRM and operational software",
              "Build integrations between systems",
              "Identify and implement automation opportunities including AI",
            ].map((item) => (
              <div
                key={item}
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <ul className="space-y-3">
            {[
              ...
              "Automation roadmap and implementation",
            ].map((item) => (
              <li key={item} className="flex items-start gap-3">
                <svg
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <div className="bg-soft-white border border-border rounded-xl p-6">
            <p className="text-slate leading-relaxed">
              Technology serves the process — we do not implement tools without
              clear process requirements.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <blockquote className="border-l-4 border-gold pl-6">
            <p className="text-ink leading-relaxed italic">
              &ldquo;A service company had five disconnected tools for leads,
              jobs, invoicing, scheduling, and customer communication. Bayshire
              designed an integrated architecture, implemented a CRM as the
              central hub, and automated lead-to-job handoff — eliminating
              three hours of daily manual data entry.&rdquo;
            </p>
          </blockquote>
          <div className="mt-8">
