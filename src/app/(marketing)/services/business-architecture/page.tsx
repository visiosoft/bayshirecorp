...
export const metadata: Metadata = {
  title: "Business Architecture | Bayshire",
  description:
    "Design how departments, roles, processes, systems, rules, and data should work together. Build a coherent operating model for your business.",
};
  ...
  return (
    <>
      <HeroSection
        ...
        description="Design how departments, roles, processes, systems, rules, and data should work together."
      />
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <ul className="space-y-4">
            {[
              ...
              "No coherent model for how the business should function",
              "Growth creating complexity without structure",
            ].map((item) => (
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              "Design process architecture across departments",
              "Map data flows and system dependencies",
              "Create decision frameworks and authority levels",
              "Specify integration requirements between systems",
            ].map((item) => (
              <div
                key={item}
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <ul className="space-y-3">
            {[
              ...
              "Data and system integration map",
              "Decision and authority framework",
            ].map((item) => (
              <li key={item} className="flex items-start gap-3">
                <svg
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <div className="bg-soft-white border border-border rounded-xl p-6">
            <p className="text-slate leading-relaxed">
              Focuses on design — implementation is a separate engagement.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <blockquote className="border-l-4 border-gold pl-6">
            <p className="text-ink leading-relaxed italic">
              &ldquo;A multi-location service company had seven departments
              operating independently. Bayshire designed a target operating
              model that connected sales, operations, and finance through
              shared data, aligned KPIs, and structured handoffs.&rdquo;
            </p>
          </blockquote>
          <div className="mt-8">
