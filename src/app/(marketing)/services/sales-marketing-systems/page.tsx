...
export const metadata: Metadata = {
  title: "Sales & Marketing Systems | Bayshire",
  description:
    "Define market approach, lead generation, CRM, scripts, follow-up, conversion reporting, and campaign execution. Build a sales system that does not depend on individual skill.",
};

export default function SalesMarketingSystemsPage() {
  return (
    <>
      <HeroSection
        variant="navy"
        ...
        description="Define market approach, lead generation, CRM, scripts, follow-up, conversion reporting, and campaign execution."
      />
      ...
      <section className="bg-white py-24 lg:py-32">
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <ul className="space-y-4">
            {[
              "Leads are not tracked or followed up",
              "Sales process depends on individual skill",
              "No visibility into conversion or campaign performance",
            ].map((item) => (
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <div className="space-y-4">
            {[
              ...
              "Design lead generation and capture systems",
              "Create sales process, scripts, and follow-up sequences",
              "Implement CRM and pipeline management",
              "Build conversion reporting and campaign tracking",
            ].map((item) => (
              <div
                key={item}
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <div className="bg-soft-white border border-border rounded-xl p-6">
            <p className="text-slate leading-relaxed">
              Covers system design and setup — ongoing campaign management is
              advisory or separate.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-[1240px] mx-auto px-6 md:px-8">
          ...
          <blockquote className="border-l-4 border-gold pl-6">
            <p className="text-ink leading-relaxed italic">
              &ldquo;A moving company relied on incoming calls with no follow-up
              system. Bayshire designed a lead capture process, created
              follow-up scripts, implemented CRM tracking, and built a
              reporting dashboard. The company could now see that 40% of quotes
              were never followed up.&rdquo;
            </p>
          </blockquote>
          <div className="mt-8">
